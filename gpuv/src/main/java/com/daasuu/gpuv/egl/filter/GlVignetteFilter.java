...
public class GlVignetteFilter extends GlFilter {
    ...
    private static final String FRAGMENT_SHADER =
            "precision mediump float;" +
                    ...
                    "lowp float splash_video = distance(vTextureCoord, vec2(vignetteCenter.x, vignetteCenter.y));" +
                    "lowp float percent = smoothstep(vignetteStart, vignetteEnd, splash_video);" +
