...
public class PlayerRecyckerView extends RecyclerView {
    ...
    private VideoPlayerRecyclerView volumeState;

    public PlayerRecyckerView(@NonNull Context context) {
        super(context);
        init(context);
    }
    public PlayerRecyckerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//        setVolumeControl(VolumeState.ON);
        ...
        videoPlayer.addListener(new Player.EventListener() {
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                ...
                View.OnClickListener videoViewClickListener = new View.OnClickListener() {
                    @Override
