...
import static com.paradox.projectsp3.Variables.pick_video_from_gallery;
...
import com.paradox.projectsp3.FileUtils;
import com.paradox.projectsp3.Functions;
import com.paradox.projectsp3.Interface.Callback;
import com.paradox.projectsp3.Interface.Fragment_Callback;
    ...
    public void startTrim(final File src, final File dst, final int startMs, final int endMs) throws IOException {
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                Functions.show_indeterminent_loader(VideoRecording_Activity.this, true, true);
            }
