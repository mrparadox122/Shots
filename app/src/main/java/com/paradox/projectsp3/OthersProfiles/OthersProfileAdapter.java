...
public class OthersProfileAdapter extends RecyclerView.Adapter<OthersProfileAdapter.myviewholder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull OthersProfileAdapter.myviewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    dataa.put("post_id",othersProfileModelList.get(position).getPid());
                    dataa.put("video_id",othersProfileModelList.get(position).getVideoid());
