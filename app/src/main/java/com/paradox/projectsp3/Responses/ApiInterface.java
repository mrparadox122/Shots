...
public interface ApiInterface {
    ...
    String userdetailurl = "http://shots.ddns.net/dashboard/paradoxApi/read.php/";
    String userfoto = "http://shots.ddns.net/dashboard/paradoxApi/profile_pic/";
    @POST("read.php")
    ...
    String userdetail_following_url = "http://shots.ddns.net/dashboard/paradoxApi/";
